...
main (int argc, char *argv[])
{
  ...
  ApplicationContainer serverApps = echoServer.Install (csmaNodes.Get (nCsma - 0));
  serverApps.Start (Seconds (1.0));
  serverApps.Stop (Seconds (25.0));

  UdpEchoClientHelper echoClient (csmaInterfaces.GetAddress (nCsma - 0), 7);
  ...
  ApplicationContainer serverApps2 = echoServer2.Install (csmaNodes.Get (nCsma - 1));
