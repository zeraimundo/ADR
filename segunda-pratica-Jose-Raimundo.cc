...
/*servidores*/
  ...
  UdpEchoServerHelper echoServer1 (7);
...
/*clientes*/
  ...
  UdpEchoClientHelper echoClient1 (csmaInterfaces.GetAddress (3), 7);
  ...
  pointToPoint.EnablePcapAll ("segunda");
  csma.EnablePcap ("segunda", csmaDevices.Get (1), true);
