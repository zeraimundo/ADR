...
NS_LOG_COMPONENT_DEFINE ("Trabalho_de_Simulacao_Jose_Raimundo");
...
int main(int argc, char *argv[]) 
{
    ...
    echoClient1.SetAttribute ("MaxPackets", UintegerValue (500));
    ...
    p2p.EnablePcap ("d2d3-0", d2d3.Get (0), true);
    p2p.EnablePcap ("d2d3-1", d2d3.Get (1), true);

    // Animation

    AnimationInterface anim("simulacao_JR.xml");
      anim.SetConstantPosition (n0n1.Get(0), 10.0, 10.0);
      anim.SetConstantPosition (n0n1.Get(1), 20.0, 10.0);
      anim.SetConstantPosition (n1n2.Get(0), 30.0, 10.0);
      anim.SetConstantPosition (n1n2.Get(1), 40.0, 10.0);
      anim.SetConstantPosition (n2n3.Get(0), 50.0, 10.0);
      anim.SetConstantPosition (n2n3.Get(1), 60.0, 10.0);
      anim.SetConstantPosition (n3n4.Get(0), 70.0, 10.0);
      anim.SetConstantPosition (n3n4.Get(1), 80.0, 10.0);
      anim.SetConstantPosition (n4n5.Get(0), 90.0, 10.0);
      anim.SetConstantPosition (n4n5.Get(1), 100.0, 10.0);
